							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Halaman Admin Data Pegawai</h2>
										<p>ini adalah halaman untuk membuat dan mengedit data pegawai <span class="bread-ntd"></span></p>
									</div>
								</div>
							</div>
                    ...
                    <div class="data-table-list">
                        ...
                        <?php if(session()->getFlashdata('msg')):?>
                            ...
                            <div class="modals-single">
                                ...
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalone">Tambah Data Pegawai</button>
